...
7. After starting ejabberd, a welcome screen should open in your default browser. You can go to the web dashboard at `http://localhost:5280/admin` and type the username `admin@domain` (or `admin@localhost` as above) and the `password` for access. The next step is to get to know [how to configure ejabberd](https://docs.ejabberd.im/admin/configuration/).
...
7. Now you can go to the web dashboard at `http://localhost:5280/admin` and type the username `admin@domain` (or `admin@localhost` as above) and the `password` for access. The next step is to get to know [how to configure ejabberd](https://docs.ejabberd.im/admin/configuration/).
...
4. Now you can go to the web dashboard at `http://localhost:5280/admin` and type the username `admin@localhost` and the `password` for access. Without configuration there's not much to see here, therefore the next step is to get to know [how to configure ejabberd](https://docs.ejabberd.im/admin/configuration/).
