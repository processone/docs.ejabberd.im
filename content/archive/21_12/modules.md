...
use [update_sql](/archive/21_12/admin-api/#update-sql) API.
...
to work, [mod_adhoc](/archive/21_12/modules/#mod-adhoc) must be enabled.
...
-   example.org/announce/all (example.org/announce/all-hosts/all):: The
    ...
    offline storage (see [mod_offline](/archive/21_12/modules/#mod-offline)) is enabled.
...
Same as top-level [cache_life_time](/archive/21_12/toplevel/#cache-life-time) option, but applied to this module
only.

- **cache\_missed**: *true | false*  
Same as top-level [cache_missed](/archive/21_12/toplevel/#cache-missed) option, but applied to this module
only.

- **cache\_size**: *pos\_integer() | infinity*  
Same as top-level [cache_size](/archive/21_12/toplevel/#cache-size) option, but applied to this module
only.

- **db\_type**: *mnesia | sql*  
Same as top-level [default_db](/archive/21_12/toplevel/#default-db) option, but applied to this module
only.

- **use\_cache**: *true | false*  
Same as top-level [use_cache](/archive/21_12/toplevel/#use-cache) option, but applied to this module only.
...
The module depends on [mod_vcard](/archive/21_12/modules/#mod-vcard), [mod_vcard_xupdate](/archive/21_12/modules/#mod-vcard-xupdate) and
[mod_pubsub](/archive/21_12/modules/#mod-pubsub).
...
Same as top-level [queue_type](/archive/21_12/toplevel/#queue-type) option, but applied to this module
only.

- **ram\_db\_type**: *mnesia | sql | redis*  
Same as [default_ram_db](/archive/21_12/toplevel/#default-ram-db) but applied to this module only.
...
requires [mod_adhoc](/archive/21_12/modules/#mod-adhoc) to be loaded.
...
[request\_handlers](/archive/21_12/listen-options/#request-handlers).
...
locally using [mod_http_fileserver](/archive/21_12/modules/#mod-http-fileserver).
...
> **Note**
>
> This module is complementary to [mod_privilege](/archive/21_12/modules/#mod-privilege) but can also be used
> separately.
...
sense if an external web server or [mod_http_fileserver](/archive/21_12/modules/#mod-http-fileserver) is used to
...
[mod_stream_mgmt](/archive/21_12/modules/#mod-stream-mgmt)) handles unacknowledged messages when the connection
...
Whether to destroy message archive of a room (see [mod_muc](/archive/21_12/modules/#mod-muc)) when it
...
the future (see [mod_muc](/archive/21_12/modules/#mod-muc)).
...
The module depends on [mod_mam](/archive/21_12/modules/#mod-mam).
...
Same as top-level [default_ram_db](/archive/21_12/toplevel/#default-ram-db) option, but applied to this module
only.
...
using an XMPP client with MUC capability. The *Options* are:
 ...
 - **logging**: *true | false*  
   The public messages are logged using
    [mod_muc_log](/archive/21_12/modules/#mod-muc-log). The default value is *false*.
...
This module depends on [mod_muc](/archive/21_12/modules/#mod-muc).
...
The module depends on [mod_muc](/archive/21_12/modules/#mod-muc).
...
when [mod_stream_mgmt](/archive/21_12/modules/#mod-stream-mgmt) is loaded and stream management is enabled by a
...
> *mod\_privacy* loaded in order for [mod_blocking](/archive/21_12/modules/#mod-blocking) to work.
...
> **Note**
>
> This module is complementary to [mod_delegation](/archive/21_12/modules/#mod-delegation), but can also be
> used separately.
...
default ejabberd configuration file, and it requires [mod_caps](/archive/21_12/modules/#mod-caps).
...
[mod_stream_mgmt](/archive/21_12/modules/#mod-stream-mgmt)) of a disconnected mobile client alive if the client
...
The module depends on [mod_push](/archive/21_12/modules/#mod-push).
...
resumption timeout configured for [mod_stream_mgmt](/archive/21_12/modules/#mod-stream-mgmt) is restored. The
...
This module reads also the top-level [registration_timeout](/archive/21_12/toplevel/#registration-timeout) option
...
[captcha_cmd](/archive/21_12/toplevel/#captcha-cmd) and top-level [captcha_url](/archive/21_12/toplevel/#captcha-url) options.
...
[request\_handlers](/archive/21_12/listen-options/#request-handlers), no need
to enable in *modules*. The module depends on [mod_register](/archive/21_12/modules/#mod-register) where all
...
[mod_shared_roster](/archive/21_12/modules/#mod-shared-roster) or [mod_shared_roster_ldap](/archive/21_12/modules/#mod-shared-roster-ldap), you must set the
...
This module depends on [mod_roster](/archive/21_12/modules/#mod-roster). If not enabled, roster queries
...
top-level [default_db](/archive/21_12/toplevel/#default-db) option, or *mnesia* if omitted. If *sql* value
...
- **ldap\_backups**  
Same as top-level [ldap_backups](/archive/21_12/toplevel/#ldap-backups) option, but applied to this module
only.

- **ldap\_base**  
Same as top-level [ldap_base](/archive/21_12/toplevel/#ldap-base) option, but applied to this module only.

- **ldap\_deref\_aliases**  
Same as top-level [ldap_deref_aliases](/archive/21_12/toplevel/#ldap-deref-aliases) option, but applied to this
module only.

- **ldap\_encrypt**  
Same as top-level [ldap_encrypt](/archive/21_12/toplevel/#ldap-encrypt) option, but applied to this module
only.
...
- **ldap\_password**  
Same as top-level [ldap_password](/archive/21_12/toplevel/#ldap-password) option, but applied to this module
only.

- **ldap\_port**  
Same as top-level [ldap_port](/archive/21_12/toplevel/#ldap-port) option, but applied to this module only.
...
- **ldap\_rootdn**  
Same as top-level [ldap_rootdn](/archive/21_12/toplevel/#ldap-rootdn) option, but applied to this module
only.

- **ldap\_servers**  
Same as top-level [ldap_servers](/archive/21_12/toplevel/#ldap-servers) option, but applied to this module
only.

- **ldap\_tls\_cacertfile**  
Same as top-level [ldap_tls_cacertfile](/archive/21_12/toplevel/#ldap-tls-cacertfile) option, but applied to this
module only.

- **ldap\_tls\_certfile**  
Same as top-level [ldap_tls_certfile](/archive/21_12/toplevel/#ldap-tls-certfile) option, but applied to this
module only.

- **ldap\_tls\_depth**  
Same as top-level [ldap_tls_depth](/archive/21_12/toplevel/#ldap-tls-depth) option, but applied to this module
only.

- **ldap\_tls\_verify**  
Same as top-level [ldap_tls_verify](/archive/21_12/toplevel/#ldap-tls-verify) option, but applied to this module
only.
...
- **ldap\_uids**  
Same as top-level [ldap_uids](/archive/21_12/toplevel/#ldap-uids) option, but applied to this module only.
...
> the [ejabberd\_sip](/archive/21_12/listen/#ejabberd-sip) listen module in
...
- **ldap\_filter**  
Same as top-level [ldap_filter](/archive/21_12/toplevel/#ldap-filter) option, but applied to this module
only.
...
The module depends on [mod_vcard](/archive/21_12/modules/#mod-vcard).
...
> along with [mod_avatar](/archive/21_12/modules/#mod-avatar) for providing backward compatibility.
