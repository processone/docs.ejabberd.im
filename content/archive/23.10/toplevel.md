...
[ejabberd-contrib](https://docs.ejabberd.im/developer/extending-ejabberd/modules/#ejabberd_contrib)
...
[captcha_host](toplevel.md#captcha_host) + /captcha. The default value is *auto*.
...
database. This option only applies if the [sql_type](toplevel.md#sql_type) option is set to
*mssql* and [sql_server](toplevel.md#sql_server) is not an ODBC connection string. The default
...
The hostname or IP address of the SQL server. For [sql_type](toplevel.md#sql_type) *mssql*
