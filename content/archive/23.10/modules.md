...
to work, [mod_adhoc](modules.md#mod_adhoc) must be enabled.
...
-   example.org/announce/all (example.org/announce/all-hosts/all):: The
    ...
    offline storage (see [mod_offline](modules.md#mod_offline)) is enabled.
...
The module depends on [mod_vcard](modules.md#mod_vcard), [mod_vcard_xupdate](modules.md#mod_vcard_xupdate) and
...
requires [mod_adhoc](modules.md#mod_adhoc) to be loaded.
...
This module is available since ejabberd <a href="../../21.12/">21.12</a>. Several options were
improved in ejabberd <a href="../../22.05/">22.05</a>.
...
<div class="note-left">added in <a href="../../22.05/">22.05</a></div>
...
> **Note**
>
> This module is complementary to [mod_privilege](modules.md#mod_privilege) but can also be used
> separately.
...
This module is available since ejabberd <a href="../../22.05/">22.05</a>.
...
sense if an external web server or [mod_http_fileserver](modules.md#mod_http_fileserver) is used to
...
[mod_stream_mgmt](modules.md#mod_stream_mgmt)) handles unacknowledged messages when the connection
...
Whether to destroy message archive of a room (see [mod_muc](modules.md#mod_muc)) when it
...
the future (see [mod_muc](modules.md#mod_muc)).
...
The module depends on [mod_mam](modules.md#mod_mam).
...
<div class="note-left">improved in <a href="../../23.10/">23.10</a></div>
...
<div class="note-left">improved in <a href="../../22.05/">22.05</a></div>
...
using an XMPP client with MUC capability. The *Options* are:
 ...
 - **logging**: *true | false*  
   The public messages are logged using
    [mod_muc_log](modules.md#mod_muc_log). The default value is *false*.
...
<div class="note-left">added in <a href="../../21.01/">21.01</a></div>
...
This module depends on [mod_muc](modules.md#mod_muc).
...
The module depends on [mod_muc](modules.md#mod_muc).
...
This module is available since ejabberd <a href="../../23.10/">23.10</a>.
...
This module is available since ejabberd <a href="../../23.04/">23.04</a>.
...
when [mod_stream_mgmt](modules.md#mod_stream_mgmt) is loaded and stream management is enabled by a
...
> *mod\_privacy* loaded in order for [mod_blocking](modules.md#mod_blocking) to work.
...
command
[bookmarks\_to\_pep](admin-api.md#bookmarks_to_pep).
...
> **Note**
>
> This module is complementary to [mod_delegation](modules.md#mod_delegation), but can also be
> used separately.
...
default ejabberd configuration file, and it requires [mod_caps](modules.md#mod_caps).
...
<div class="note-left">added in <a href="../../21.12/">21.12</a></div>
...
<div class="note-left">added in <a href="../../23.10/">23.10</a></div>
...
[mod_stream_mgmt](modules.md#mod_stream_mgmt)) of a disconnected mobile client alive if the client
...
The module depends on [mod_push](modules.md#mod_push).
...
resumption timeout configured for [mod_stream_mgmt](modules.md#mod_stream_mgmt) is restored. The
...
- **captcha\_protected**: *true | false*  
Protect registrations with [CAPTCHA](../../admin/configuration/basic.md#captcha). The
default is *false*.
...
This module supports [CAPTCHA](../../admin/configuration/basic.md#captcha) to register a
...
to enable in *modules*. The module depends on [mod_register](modules.md#mod_register) where all
...
[mod_shared_roster](modules.md#mod_shared_roster) or [mod_shared_roster_ldap](modules.md#mod_shared_roster_ldap), you must set the
...
This module depends on [mod_roster](modules.md#mod_roster). If not enabled, roster queries
...
module is included in ejabberd since version <a href="../../20.04/">20.04</a>.
...
The module depends on [mod_vcard](modules.md#mod_vcard).
...
> along with [mod_avatar](modules.md#mod_avatar) for providing backward compatibility.
