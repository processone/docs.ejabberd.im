...
You can use [host\_config](/archive/20_12/toplevel/#host-config) to specify
this option per-vhost.

To set a specific file per listener, use the listener’s
[cafile](/archive/20_12/listen-options/#cafile) option. Please notice that
...
[s2s\_cafile](/archive/20_12/toplevel/#s2s-cafile) option.
...
Modules](/archive/20_12/listen/) section for details.
...
The option for modules configuration. See [Modules](/archive/20_12/modules/)
section for details.
...
[ca\_file](/archive/20_12/toplevel/#ca-file) will be used.
