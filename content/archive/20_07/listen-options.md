...
[`certfiles`](/archive/20_07/toplevel/#certfiles) top-level option
...
[`ejabberd_service`](/archive/20_07/listen/#ejabberd-service) only.
...
defined in [`hosts`](/archive/20_07/toplevel/#hosts)
...
[`ejabberd_service`](/archive/20_07/listen/#ejabberd-service)
...
This option specifies the maximum number of elements in the queue of
	...
	on your hardware configuration. This option can be specified for
        [`ejabberd_service`](/archive/20_07/listen/#ejabberd-service)
        and [`ejabberd_c2s`](/archive/20_07/listen/#ejabberd-c2s)
        listeners, or also globally for
        [`ejabberd_s2s_out`](/archive/20_07/listen/#ejabberd-s2s-out).
...
[`ejabberd_http`](/archive/20_07/listen/#ejabberd-http). The
...
[`ejabberd_service`](/archive/20_07/listen/#ejabberd-service) (see
...
[`api_permissions`](/archive/20_07/toplevel/#api_permissions)
just for it.
...
If this option is set, you should also set the
        [`certfiles`](/archive/20_07/toplevel/#certfiles) top-level
