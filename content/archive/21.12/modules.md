...
Same as [default_ram_db](toplevel.md#default_ram_db) but applied to this module only.
...
This module is available since ejabberd <a href="../../21.12/">21.12</a>.
...
locally using [mod_http_fileserver](modules.md#mod_http_fileserver).
...
top-level [default_db](toplevel.md#default_db) option, or *mnesia* if omitted. If *sql* value
