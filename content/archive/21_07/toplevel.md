...
You can use [host\_config](/archive/21_07/toplevel/#host-config) to specify
this option per-vhost.

To set a specific file per listener, use the listener’s
[cafile](/archive/21_07/listen-options/#cafile) option. Please notice that
...
Modules](/archive/21_07/listen/) section for details.
...
The option for modules configuration. See [Modules](/archive/21_07/modules/)
section for details.
...
[ca\_file](/archive/21_07/toplevel/#ca-file) will be used.
