...
[`c2s_cafile`](/archive/22_05/toplevel/#c2s-cafile) top-level option.
To set a file for all server connections, you can use the
[`s2s_cafile`](/archive/22_05/toplevel/#s2s-cafile) top-level option
or the
[`ca_file`](/archive/22_05/toplevel/#ca-file) top-level option.

Please note: if this option is set in
[`ejabberd_c2s`](/archive/22_05/listen/#ejabberd-c2s)
or [`ejabberd_s2s_in`](/archive/22_05/listen/#ejabberd-s2s-in)
and the corresponding top-level option is also set
([`c2s_cafile`](/archive/22_05/toplevel/#c2s-cafile),
[`s2s_cafile`](/archive/22_05/toplevel/#s2s-cafile)),
...
[`certfiles`](/archive/22_05/toplevel/#certfiles) top-level option
...
[`ejabberd_service`](/archive/22_05/listen/#ejabberd-service) only.
...
or [`ejabberd_s2s_in`](/archive/22_05/listen/#ejabberd-s2s-in)
and the corresponding top-level option is also set
([`c2s_ciphers`](/archive/22_05/toplevel/#c2s-ciphers),
[`s2s_ciphers`](/archive/22_05/toplevel/#s2s-ciphers)),
then the top-level option is used, not this one.
...
or [`ejabberd_s2s_in`](/archive/22_05/listen/#ejabberd-s2s-in)
and the corresponding top-level option is also set
([`c2s_dhfile`](/archive/22_05/toplevel/#c2s-dhfile),
[`s2s_dhfile`](/archive/22_05/toplevel/#s2s-dhfile)),
then the top-level option is used, not this one.
...
defined in [`hosts`](/archive/22_05/toplevel/#hosts)
...
[`ejabberd_service`](/archive/22_05/listen/#ejabberd-service)
...
This option specifies the maximum number of elements in the queue of
	...
	on your hardware configuration. This option can be specified for
        [`ejabberd_service`](/archive/22_05/listen/#ejabberd-service)
        and [`ejabberd_c2s`](/archive/22_05/listen/#ejabberd-c2s)
        listeners, or also globally for
        [`ejabberd_s2s_out`](/archive/22_05/listen/#ejabberd-s2s-out).
...
or [`ejabberd_s2s_in`](/archive/22_05/listen/#ejabberd-s2s-in)
and the corresponding top-level option is also set
([`c2s_protocol_options`](/archive/22_05/toplevel/#c2s-protocol-options),
[`s2s_protocol_options`](/archive/22_05/toplevel/#s2s-protocol-options)),
then the top-level option is used, not this one.
...
[`ejabberd_http`](/archive/22_05/listen/#ejabberd-http). The
...
[`ejabberd_service`](/archive/22_05/listen/#ejabberd-service) (see
...
[`api_permissions`](/archive/22_05/toplevel/#api-permissions)
just for it.
...
If this option is set, you should also set the
        [`certfiles`](/archive/22_05/toplevel/#certfiles) top-level
...
or [`ejabberd_s2s_in`](/archive/22_05/listen/#ejabberd-s2s-in)
and the corresponding top-level option is also set
([`c2s_tls_compression`](/archive/22_05/toplevel/#c2s-tls-compression),
[`s2s_tls_compression`](/archive/22_05/toplevel/#s2s-tls-compression)),
then the top-level option is used, not this one.
