...
the module is loaded use [update_sql](/archive/24_02/admin-api/#update-sql) API.
...
to work, [mod_adhoc](/archive/24_02/modules/#mod-adhoc) must be enabled.
...
-   example.org/announce/all (example.org/announce/all-hosts/all):: The
    ...
    offline storage (see [mod_offline](/archive/24_02/modules/#mod-offline)) is enabled.
...
Same as top-level [cache_life_time](/archive/24_02/toplevel/#cache-life-time) option, but applied to this module
only.

- **cache\_missed**: *true | false*  
Same as top-level [cache_missed](/archive/24_02/toplevel/#cache-missed) option, but applied to this module
only.

- **cache\_size**: *pos\_integer() | infinity*  
Same as top-level [cache_size](/archive/24_02/toplevel/#cache-size) option, but applied to this module
only.

- **db\_type**: *mnesia | sql*  
Same as top-level [default_db](/archive/24_02/toplevel/#default-db) option, but applied to this module
only.

- **use\_cache**: *true | false*  
Same as top-level [use_cache](/archive/24_02/toplevel/#use-cache) option, but applied to this module only.
...
The module depends on [mod_vcard](/archive/24_02/modules/#mod-vcard), [mod_vcard_xupdate](/archive/24_02/modules/#mod-vcard-xupdate) and
[mod_pubsub](/archive/24_02/modules/#mod-pubsub).
...
Same as top-level [queue_type](/archive/24_02/toplevel/#queue-type) option, but applied to this module
only.

- **ram\_db\_type**: *mnesia | sql | redis*  
Same as top-level [default_ram_db](/archive/24_02/toplevel/#default-ram-db) option, but applied to this module
only.
...
requires [mod_adhoc](/archive/24_02/modules/#mod-adhoc) to be loaded.
...
[request\_handlers](/archive/24_02/listen-options/#request-handlers).

Make sure either *mod\_bosh* or *ejabberd\_http\_ws*
[request\_handlers](/archive/24_02/listen-options/#request-handlers) are
enabled.
...
> **Note**
>
> This module is complementary to [mod_privilege](/archive/24_02/modules/#mod-privilege) but can also be used
> separately.
...
sense if an external web server or [mod_http_fileserver](/archive/24_02/modules/#mod-http-fileserver) is used to
...
[mod_stream_mgmt](/archive/24_02/modules/#mod-stream-mgmt)) handles unacknowledged messages when the connection
...
Whether to destroy message archive of a room (see [mod_muc](/archive/24_02/modules/#mod-muc)) when it
...
the future (see [mod_muc](/archive/24_02/modules/#mod-muc)).
...
The module depends on [mod_mam](/archive/24_02/modules/#mod-mam).
...
capability. The *Options* are:
 ...
 - **logging**: *true | false*  
   The public messages are logged using
    [mod_muc_log](/archive/24_02/modules/#mod-muc-log). The default value is *false*.
...
This module depends on [mod_muc](/archive/24_02/modules/#mod-muc).
...
The module depends on [mod_muc](/archive/24_02/modules/#mod-muc).
...
server ping request. NOTE: when [mod_stream_mgmt](/archive/24_02/modules/#mod-stream-mgmt) is loaded and stream
...
when [mod_stream_mgmt](/archive/24_02/modules/#mod-stream-mgmt) is loaded and stream management is enabled by a
...
> *mod\_privacy* loaded in order for [mod_blocking](/archive/24_02/modules/#mod-blocking) to work.
...
command
[bookmarks\_to\_pep](https://docs.ejabberd.im/archive/24_02/admin-api/#bookmarks-to-pep).
...
> **Note**
>
> This module is complementary to [mod_delegation](/archive/24_02/modules/#mod-delegation), but can also be
> used separately.
...
default ejabberd configuration file, and it requires [mod_caps](/archive/24_02/modules/#mod-caps).
...
[mod_stream_mgmt](/archive/24_02/modules/#mod-stream-mgmt)) of a disconnected mobile client alive if the client
...
The module depends on [mod_push](/archive/24_02/modules/#mod-push).
...
resumption timeout configured for [mod_stream_mgmt](/archive/24_02/modules/#mod-stream-mgmt) is restored. The
...
This module reads also the top-level [registration_timeout](/archive/24_02/toplevel/#registration-timeout) option
...
[captcha_cmd](/archive/24_02/toplevel/#captcha-cmd) and top-level [captcha_url](/archive/24_02/toplevel/#captcha-url) options.
...
[request\_handlers](/archive/24_02/listen-options/#request-handlers), no need
to enable in *modules*. The module depends on [mod_register](/archive/24_02/modules/#mod-register) where all
...
[mod_shared_roster](/archive/24_02/modules/#mod-shared-roster) or [mod_shared_roster_ldap](/archive/24_02/modules/#mod-shared-roster-ldap), you must set the
...
This module depends on [mod_roster](/archive/24_02/modules/#mod-roster). If not enabled, roster queries
...
- **ldap\_backups**  
Same as top-level [ldap_backups](/archive/24_02/toplevel/#ldap-backups) option, but applied to this module
only.

- **ldap\_base**  
Same as top-level [ldap_base](/archive/24_02/toplevel/#ldap-base) option, but applied to this module only.

- **ldap\_deref\_aliases**  
Same as top-level [ldap_deref_aliases](/archive/24_02/toplevel/#ldap-deref-aliases) option, but applied to this
module only.

- **ldap\_encrypt**  
Same as top-level [ldap_encrypt](/archive/24_02/toplevel/#ldap-encrypt) option, but applied to this module
only.
...
- **ldap\_password**  
Same as top-level [ldap_password](/archive/24_02/toplevel/#ldap-password) option, but applied to this module
only.

- **ldap\_port**  
Same as top-level [ldap_port](/archive/24_02/toplevel/#ldap-port) option, but applied to this module only.
...
- **ldap\_rootdn**  
Same as top-level [ldap_rootdn](/archive/24_02/toplevel/#ldap-rootdn) option, but applied to this module
only.

- **ldap\_servers**  
Same as top-level [ldap_servers](/archive/24_02/toplevel/#ldap-servers) option, but applied to this module
only.

- **ldap\_tls\_cacertfile**  
Same as top-level [ldap_tls_cacertfile](/archive/24_02/toplevel/#ldap-tls-cacertfile) option, but applied to this
module only.

- **ldap\_tls\_certfile**  
Same as top-level [ldap_tls_certfile](/archive/24_02/toplevel/#ldap-tls-certfile) option, but applied to this
module only.

- **ldap\_tls\_depth**  
Same as top-level [ldap_tls_depth](/archive/24_02/toplevel/#ldap-tls-depth) option, but applied to this module
only.

- **ldap\_tls\_verify**  
Same as top-level [ldap_tls_verify](/archive/24_02/toplevel/#ldap-tls-verify) option, but applied to this module
only.
...
- **ldap\_uids**  
Same as top-level [ldap_uids](/archive/24_02/toplevel/#ldap-uids) option, but applied to this module only.
...
> the [ejabberd\_sip](/archive/24_02/listen/#ejabberd-sip) listen module in
...
- **ldap\_filter**  
Same as top-level [ldap_filter](/archive/24_02/toplevel/#ldap-filter) option, but applied to this module
only.
...
The module depends on [mod_vcard](/archive/24_02/modules/#mod-vcard).
...
> along with [mod_avatar](/archive/24_02/modules/#mod-avatar) for providing backward compatibility.
