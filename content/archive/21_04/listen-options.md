...
[`c2s_cafile`](/archive/21_04/toplevel/#c2s-cafile) top-level option.
To set a file for all server connections, you can use the
[`s2s_cafile`](/archive/21_04/toplevel/#s2s-cafile) top-level option
or the
[`ca_file`](/archive/21_04/toplevel/#ca-file) top-level option.
...
[`certfiles`](/archive/21_04/toplevel/#certfiles) top-level option
...
[`ejabberd_service`](/archive/21_04/listen/#ejabberd-service) only.
...
defined in [`hosts`](/archive/21_04/toplevel/#hosts)
...
[`ejabberd_service`](/archive/21_04/listen/#ejabberd-service)
...
This option specifies the maximum number of elements in the queue of
	...
	on your hardware configuration. This option can be specified for
        [`ejabberd_service`](/archive/21_04/listen/#ejabberd-service)
        and [`ejabberd_c2s`](/archive/21_04/listen/#ejabberd-c2s)
        listeners, or also globally for
        [`ejabberd_s2s_out`](/archive/21_04/listen/#ejabberd-s2s-out).
...
[`ejabberd_http`](/archive/21_04/listen/#ejabberd-http). The
...
[`ejabberd_service`](/archive/21_04/listen/#ejabberd-service) (see
...
[`api_permissions`](/archive/21_04/toplevel/#api-permissions)
just for it.
...
If this option is set, you should also set the
        [`certfiles`](/archive/21_04/toplevel/#certfiles) top-level
